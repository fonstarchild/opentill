...
Uses the Stripe Terminal SDK to charge a physical card reader.
Requires a Stripe account and a compatible reader (BBPOS WisePOS E,
Stripe Reader S700, etc.).

Docs: https://docs.stripe.com/terminal
"""
...
class StripeTerminalProvider(PaymentProvider):
    id = "STRIPE_TERMINAL"
